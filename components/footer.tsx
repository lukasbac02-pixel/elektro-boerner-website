        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="bg-gray-800 rounded-lg overflow-hidden h-48 mb-4">
              <iframe
                src="https://www.openstreetmap.org/export/embed.html?bbox=8.998413085937502%2C46.998413085937502%2C9.000413085937502%2C47.000413085937502&layer=mapnik&marker=46.999413085937502%2C8.999413085937502"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                loading="lazy"
