...
const services = [
  {
    ...
    description:
      "Professionelle Beratung und sorgfältige Planung für Ihr Elektroprojekt. Von der ersten Idee bis zur Umsetzung begleiten wir Sie kompetent.",
    icon: Lightbulb,
  ...
  },
  {
    ...
    description:
      "Fachgerechte Installation von Elektrosystemen, Solaranlagen, E-Mobility-Lösungen und Wärmepumpen für moderne und nachhaltige Energieversorgung.",
    icon: Wrench,
  ...
  },
  {
    title: "Kontrollen",
    description:
      "Periodische Sicherheitskontrollen und Prüfungen Ihrer Elektroinstallation gemäss NIV. Für Ihre Sicherheit und gesetzliche Compliance.",
    icon: Shield,
  ...
  },
  {
    ...
    description:
      "Installation und Wartung von Telefon- und Internetanschlüssen. Moderne Kommunikationslösungen für Ihr Zuhause oder Büro.",
    icon: Phone,
  ...
  return (
    <section className="py-32 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto max-w-6xl px-4 md:px-6">
        ...
        <StaggerChildren className="grid md:grid-cols-2 gap-8 mb-12">
          {services.map((service) => {
            const Icon = service.icon;
            return (
              <Card
                key={service.title}
                className="border-primary/20 shadow-lg hover:shadow-xl transition-shadow flex flex-col"
              >
                <CardHeader>
