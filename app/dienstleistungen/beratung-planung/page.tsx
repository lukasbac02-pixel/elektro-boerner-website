...
import { ClipboardList, Calculator, Lightbulb, TrendingUp } from "lucide-react";
        ...
        <div className="container mx-auto max-w-7xl px-6">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link href="/dienstleistungen" className="text-sm font-medium text-gray-900 hover:text-primary transition-colors">
                Dienstleistungen
              </Link>
              <Link href="/kontakt">
